...
public class DeleteAssessmentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(!(Assessment.delete(assessmentId, connection))){
            message = "There is score in this assessment. Please remove score first.";
        }
        try {
            connection.close();
        ...
        response.sendRedirect("ViewAssessmentServlet?courseId="+courseId+"&message="+message);
    }
